      ...
      <div class="navbar navbar-default" role="navigation">
        ...
        <div class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
			...
			<li class="active"><a href="Crime.php">Crime Watch App</a></li>
      ...
      <!-- Main Video -->
		...
		<center>
			<video width="90%" height="700" controls>
			  <source src="img/CrimePromo.mp4" type="video/mp4">
			</video>
		</center>
		</div>
		<br><br><br><br><br>
	 	<div class="col-md-12">
			<div class="jumbotron">
				<h1>The New Crime Watch App</h1>
				<h1><small>Get the app now</small><h1>
